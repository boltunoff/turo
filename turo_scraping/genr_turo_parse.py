...
# url = "https://turo.com/search?country=US&defaultZoomLevel=11&endDate=12%2F21%2F2018&endTime=10%3A00&international=true&isMapSearch=false&itemsPerPage=200&latitude=41.8781136&location=Chicago%2C%20IL%2C%20USA&locationType=City&longitude=-87.6297982&maximumDistanceInMiles=30&region=IL&sortType=RELEVANCE&startDate=12%2F18%2F2018&startTime=10%3A00"
# driver.get(url)
# soup = BeautifulSoup(driver.page_source,"html.parser")
...
# driver.current_url:
# 'https://turo.com/search?location=chicago&country=&region=&locationType='
##############
##############
...
driver.save_screenshot('chgo_srch.png')
driver.current_url
# 'https://turo.com/search?location=Chicago&country=&region=&locationType=&startDate=11%2F12%2F2018&startTime=10%3A00&endDate=11%2F19%2F2018&endTime=10%3A00'
